...
class Settings(BaseSettings):
    ...
    RUNPOD_WEBHOOK_MAX_BODY_BYTES: int = 1 * 1024 * 1024
    RUNPOD_WEBHOOK_LEASE_SECONDS: int = 60
    MAX_GENERATION_ATTEMPTS: int = 2
    MAX_ACTIVE_GENERATIONS_PER_USER: int = 2
    MAX_DAILY_GENERATIONS_PER_USER: int = 20
    GENERATION_OUTPUT_PURGE_DELAY_SECONDS: int = 3600
    GENERATION_SIGNED_URL_TTL_SECONDS: int = 7200
    GENERATION_LEASE_SECONDS: int = 60
    GENERATION_POLL_SECONDS: int = 5
    GENERATION_QUEUE_TIMEOUT_SECONDS: int = 900
